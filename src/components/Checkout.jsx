...
const Checkout = () => {
    ...
    const doValidation = ()=>{
        ...
        if(!validaTextoIngresado([txtNombre,txtApellido,txtEmail,txtEmailConfirmacion,txtFono])){
    ...
    const doCheckout = async (event)=>{
        ...
        try{            
            ...
            const newOrder = {
                cliente,
                items: cart.map((p)=>{return {"id":p.id,"cantidad":p.quantity,"nombre":p.productName,"precio":p.price}}),
                total: totalPrice(),
        ...
        <>
            ...
            <div className="contacto">
                ...
                <div className="contacto__item contacto__img_box">
                    <h3>
                        Completa tus datos para realizar orden compra.
                    </h3>
                </div>
                {/* inicio formulario */}
                <div className="contacto__item contacto__form">
                    <form id="frmOrdenCompra" onSubmit={()=>doCheckout(event)}>
                        {/* 1ra linea */}
                            ...
                            <div className="contacto__linea_control">
                                { !hayError() &&
                                    <button
                                        ...
                                        onClick={() => {doSubmit()}}
                                        >
                                        Realizar Compra <i className="fa fa-money" aria-hidden="true"></i>
                                    </button>
                                }
                            </div>
                        </div>{/*fin hacer checkout */}
                        ...
                        <div className="contacto__linea">
                            <div className="alert-box alert-box--success">
                                ...
                                Compra realizada con exito. ID de orden de compra: <strong>{idNewOrder}</strong> 
                            </div>
                        </div>        
                        }
